...
type ColorRGB_i16 struct {
	_tab flatbuffers.Struct
}

func (rcv *ColorRGB_i16) Init(buf []byte, i flatbuffers.UOffsetT) {
	rcv._tab.Bytes = buf
	rcv._tab.Pos = i
}

func (rcv *ColorRGB_i16) Table() flatbuffers.Table {
	return rcv._tab.Table
}

func (rcv *ColorRGB_i16) R() int16 {
	return rcv._tab.GetInt16(rcv._tab.Pos + flatbuffers.UOffsetT(0))
}
func (rcv *ColorRGB_i16) MutateR(n int16) bool {
	return rcv._tab.MutateInt16(rcv._tab.Pos+flatbuffers.UOffsetT(0), n)
}

func (rcv *ColorRGB_i16) G() int16 {
	return rcv._tab.GetInt16(rcv._tab.Pos + flatbuffers.UOffsetT(2))
}
func (rcv *ColorRGB_i16) MutateG(n int16) bool {
	return rcv._tab.MutateInt16(rcv._tab.Pos+flatbuffers.UOffsetT(2), n)
}

func (rcv *ColorRGB_i16) B() int16 {
	return rcv._tab.GetInt16(rcv._tab.Pos + flatbuffers.UOffsetT(4))
}
func (rcv *ColorRGB_i16) MutateB(n int16) bool {
	return rcv._tab.MutateInt16(rcv._tab.Pos+flatbuffers.UOffsetT(4), n)
}

func CreateColorRGB_i16(builder *flatbuffers.Builder, r int16, g int16, b int16) flatbuffers.UOffsetT {
	builder.Prep(2, 6)
