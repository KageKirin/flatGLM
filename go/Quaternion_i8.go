...
type Quaternion_i8 struct {
	_tab flatbuffers.Struct
}

func (rcv *Quaternion_i8) Init(buf []byte, i flatbuffers.UOffsetT) {
	rcv._tab.Bytes = buf
	rcv._tab.Pos = i
}

func (rcv *Quaternion_i8) Table() flatbuffers.Table {
	return rcv._tab.Table
}

func (rcv *Quaternion_i8) X() int8 {
	return rcv._tab.GetInt8(rcv._tab.Pos + flatbuffers.UOffsetT(0))
}
func (rcv *Quaternion_i8) MutateX(n int8) bool {
	return rcv._tab.MutateInt8(rcv._tab.Pos+flatbuffers.UOffsetT(0), n)
}

func (rcv *Quaternion_i8) Y() int8 {
	return rcv._tab.GetInt8(rcv._tab.Pos + flatbuffers.UOffsetT(1))
}
func (rcv *Quaternion_i8) MutateY(n int8) bool {
	return rcv._tab.MutateInt8(rcv._tab.Pos+flatbuffers.UOffsetT(1), n)
}

func (rcv *Quaternion_i8) Z() int8 {
	return rcv._tab.GetInt8(rcv._tab.Pos + flatbuffers.UOffsetT(2))
}
func (rcv *Quaternion_i8) MutateZ(n int8) bool {
	return rcv._tab.MutateInt8(rcv._tab.Pos+flatbuffers.UOffsetT(2), n)
}

func (rcv *Quaternion_i8) W() int8 {
	return rcv._tab.GetInt8(rcv._tab.Pos + flatbuffers.UOffsetT(3))
}
func (rcv *Quaternion_i8) MutateW(n int8) bool {
	return rcv._tab.MutateInt8(rcv._tab.Pos+flatbuffers.UOffsetT(3), n)
}

func CreateQuaternion_i8(builder *flatbuffers.Builder, x int8, y int8, z int8, w int8) flatbuffers.UOffsetT {
	builder.Prep(1, 4)
